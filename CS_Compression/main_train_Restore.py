...
parser.add_argument("--modelName",type=str,default="Restore")
...
image_paths_train       = f"./dataset/im16"
image_paths_output =    f"./dataset/Y"
dataset_train           = CustomDataloader(image_paths_train,image_paths_output)
