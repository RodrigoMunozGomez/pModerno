...
parser.add_argument("--modelName",type=str,default="CSAE")

parser.add_argument("--iSize",type=int,default=409)
...
model = CSAutoencoderPlus(input_size=iSize,output_size=oSize).to(device)
...
image_paths_train       = f"./dataset/rest"
